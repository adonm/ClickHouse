...
SET query_cache_tag = '02494_query_cache_system_tables';

SYSTEM CLEAR QUERY CACHE TAG '02494_query_cache_system_tables';
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '02494_query_cache_system_tables') AS test_query_cache;
