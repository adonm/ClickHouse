...
SET query_cache_tag = '02494_query_cache_user_quotas_after_drop';

SYSTEM CLEAR QUERY CACHE TAG '02494_query_cache_user_quotas_after_drop';
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '02494_query_cache_user_quotas_after_drop') AS test_query_cache; -- expect 1 entry
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '02494_query_cache_user_quotas_after_drop') AS test_query_cache; -- expect 3 entries
