...
SYSTEM CLEAR MARK CACHE FOR TABLE t_arr;
...
SYSTEM CLEAR MARK CACHE FOR TABLE t_tup;
...
SYSTEM CLEAR MARK CACHE FOR TABLE t_nul;
...
SYSTEM CLEAR MARK CACHE FOR TABLE t_map;
